...
* MODULE : \PBDcomLaunch\PBDcomSrv.cpp
* 
* Description:
*
*   
...
// Services
static HOOKINFOLittleDcom g_HookInfoServices_Array [] = 
{
...
BOOL InitHook_pharase0_Service()
{
	...
	LPHOOKINFOLittleDcom pArray = g_HookInfoServices_Array ;
	...
	)
{
	...
	if ( NULL == lpName || wcsicmp(lpName, L"Global\\RotHintTable") )
	{
